...
class BotNeckAPI {
    ...
    /** @returns {boolean} Returns true if the Auth Headers from an XMLHttpRequest were set successfully. */
    ...
    /** @returns {any} Returns a rich message embed. */
    ...
    /** @returns {String} Returns all of the arguments as a string */
